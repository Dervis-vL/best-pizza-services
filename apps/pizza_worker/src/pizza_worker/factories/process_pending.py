"""Process pending for maintenance jobs factory."""
...
def build_process_pending_uc(engine: Engine) -> use_cases.ProcessPendingUseCase:
    """Build and wire the ProcessPendingUseCase from worker engine."""
