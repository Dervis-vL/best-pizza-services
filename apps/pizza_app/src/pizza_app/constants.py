...
class AppContext:
    ...
    DISCLAIMER: Final[str] = """
        **Disclaimer:**\n
        ...
        of its respective owners. This application does not claim any rights over the data.
        The data has not been altered, manipulated, or editorially modified in any way
        — it is reproduced as published. This application is an independent, non-commercial
