...
Revision ID: 9e3212935023
Revises: 
Create Date: 2026-02-26 16:03:46.948067
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('latitude', 'longitude', name='uq_location_latitude_longitude'),
    schema='api_v1'
    )
    op.create_table('ranking_editions',
    ...
    sa.Column('year', sa.SmallInteger(), nullable=False, comment='Year of the ranking edition'),
    sa.Column('url', sa.String(length=500), nullable=False, comment='Endpoint URL for the ranking edition data'),
...
def downgrade() -> None:
    ...
    op.drop_table('ranking_editions', schema='api_v1')
