"""Mark edition as scraped or parsed use case."""
...
class MarkEditionAsParsedUseCase:  # pylint: disable=too-few-public-methods
    """Mark edition as parsed use case."""
    ...
    def execute(self, edition_id: int) -> bool:
        """Execute the use case."""
        self._ranking_repository.mark_edition_parsed(edition_id=edition_id)
        return True