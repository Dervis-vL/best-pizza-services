...
class StoreWebpageHtmlUseCase:  # pylint: disable=too-few-public-methods
    """Store a scraped webpage's HTML to object storage."""
    ...
    def execute(
        ...
        *,
        ...
        return self._html_repository.save_html(
            html=html,
            model_id=model_id,
            model_name=shared_enums.HtmlModelName.WEBPAGES,
        )


class GetWebpageHtmlUseCase:  # pylint: disable=too-few-public-methods
    """Get a scraped webpage's HTML from storage, as Beautifulsoup."""
    ...
    def execute(self, *, model_id: int) -> bs4.BeautifulSoup:
        """Get the webpage's HTML string from storage as soup."""
...
class ListWebpageKeysUseCase:  # pylint: disable=too-few-public-methods
    ...
    def execute(self) -> list[str]:
        """List and return stored webpage HTML keys."""
        return self._html_repository.list_keys(model_name=shared_enums.HtmlModelName.WEBPAGES)
