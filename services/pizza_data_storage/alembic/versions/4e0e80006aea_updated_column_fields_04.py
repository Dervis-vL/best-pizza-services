"""Updated column fields 04

Revision ID: 4e0e80006aea
Revises: 852a352efb90
Create Date: 2026-04-24 18:03:47.857940
...
revision: str = '4e0e80006aea'
down_revision: Union[str, Sequence[str], None] = '852a352efb90'
...
def upgrade() -> None:
    ...
    op.drop_index(op.f('tiger_place_the_geom_gist'), table_name='place', schema='tiger', postgresql_using='gist')
    ...
    op.alter_column('categories', 'name',
               ...
               existing_comment='Name of the pizza category',
