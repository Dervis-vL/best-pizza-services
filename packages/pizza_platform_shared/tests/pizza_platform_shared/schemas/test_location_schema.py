...
class TestLocationSchema:
    ...
    def test_valid_construction(self, data: dict) -> None:
        """Accepts any valid combination of location fields and preserves pizzeria_id."""
        schema = LocationSchema(**data)
        assert schema.pizzeria_id == data["pizzeria_id"]
    ...
    def test_has_coordinates_true(self, lat: float, lng: float) -> None:
        ...
        schema = LocationSchema(pizzeria_id=1, latitude=lat, longitude=lng)
    ...
    def test_has_coordinates_false_when_lat_none(self) -> None:
        ...
        schema = LocationSchema(pizzeria_id=1, latitude=None, longitude=0.0)
    ...
    def test_has_coordinates_false_when_lng_none(self) -> None:
        ...
        schema = LocationSchema(pizzeria_id=1, latitude=0.0, longitude=None)
        assert schema.has_coordinates is False

    def test_phone_none_passes_through(self) -> None:
        """Preserves None as the phone value without coercion."""
        schema = LocationSchema(pizzeria_id=1, latitude=None, longitude=None, phone=None)
    ...
    def test_phone_empty_string_passes_through(self) -> None:
        ...
        schema = LocationSchema(pizzeria_id=1, latitude=None, longitude=None, phone="")
        assert schema.phone == ""
    ...
    def test_phone_within_limit_passes_through(self, phone: str) -> None:
        ...
        schema = LocationSchema(pizzeria_id=1, latitude=None, longitude=None, phone=phone)
    ...
    def test_latitude_required(self) -> None:
        ...
        with pytest.raises(pyd.ValidationError):
            LocationSchema(pizzeria_id=1, longitude=None)  # type: ignore[call-arg]

    def test_longitude_required(self) -> None:
        """Raises ValidationError when longitude is omitted."""
        with pytest.raises(pyd.ValidationError):
            LocationSchema(pizzeria_id=1, latitude=None)  # type: ignore[call-arg]
...
class TestLocationReadSchema:
    ...
    def test_id_required(self) -> None:
        ...
        with pytest.raises(pyd.ValidationError):
            LocationReadSchema(pizzeria_id=1, latitude=None, longitude=None)
